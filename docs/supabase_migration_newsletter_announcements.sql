...
-- À exécuter dans Supabase > SQL Editor après `supabase_migration_dashboard.sql` (nécessite public.is_admin()).
-- Version alignée sur : supabase/migrations/20260419150000_newsletter_site_announcements.sql
...
-- Lecture publique : annonces actives non expirées
...
-- Admins : tout voir (y compris brouillons / expirés)
...
-- Inscription anonyme (anti-spam basique : format email)
