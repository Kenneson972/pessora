...
- 🔎 **LA RECETTE DE LA PAGE — 7 portes, toutes mesurables, aucune au jugé** (écrites et testées à blanc par @vela ; le détail d'exécution vit dans son script, les définitions ici) :
