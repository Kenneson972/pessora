...
export const rangesData = {
  ...
  sport: {
    ...
    products: [
      ...
      { name: 'Gel Prolong',             description: 'Énergie soutenue pour efforts longs.',              price: '35€', image: 'https://www.herbalife.com/dmassets/market-reusable-assets/emea/france/images/canister/pc-1424-fr.png' },
      ...
      { name: 'LiftOff Pamplemousse',    description: 'Tablette effervescente énergie — pamplemousse.',   price: '40€', image: 'https://www.herbalife.com/dmassets/market-reusable-assets/emea/france/images/canister/pc-192k-fr.png' },
