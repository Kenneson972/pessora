...
export const rangesData = {
  ...
  sport: {
    ...
    products: [
      ...
      { name: 'Chips BBQ Onions x10',    description: "Encas savoureux riche en protéines, parfait pour combler une petite faim sans culpabiliser. Saveur barbecue et oignon irrésistible. Format boîte de 10 sachets individuels.", price: '30€', image: 'https://www.herbalife.com/dmassets/market-reusable-assets/emea/france/images/canister/pc-142k-fr.png' },
      ...
      { name: 'Barre Sport x6',          description: "Barre protéinée conçue pour la récupération musculaire après l'effort. Riche en protéines et en fibres, elle aide à la reconstruction tout en offrant une sensation de satiété. Pack de 6 barres.", price: '35€', image: 'https://www.herbalife.com/dmassets/market-reusable-assets/emea/france/images/canister/pc-150k-fr.png' },
      ...
      { name: 'Barre Céréales x7',       description: "Barre céréales croustillante et saine, idéale pour un boost d'énergie avant ou après l'entraînement. Riche en fibres et protéines, sans excès de sucres. Pack de 7 barres.", price: '35€', image: 'https://www.herbalife.com/dmassets/market-reusable-assets/emea/france/images/canister/pc-4472-fr.png' },
      ...
      { name: 'Barres Collations x14',   description: "Pack varié de 14 barres collation, parfait pour découvrir toutes les saveurs. Un concentré de protéines et de fibres dans un format pratique à emporter partout. Idéal au bureau ou en randonnée.", price: '40€', image: 'https://www.herbalife.com/dmassets/market-reusable-assets/emea/france/images/canister/pc-3976-fr.png' },
      ...
      { name: 'Electrolytes Sachet x10', description: "Sachets individuels d'électrolytes pour l'hydratation pendant l'effort. Format pratique à glisser dans le sac de sport. Formule hypotonique à absorption rapide.", price: '30€', image: 'https://www.herbalife.com/dmassets/market-reusable-assets/emea/france/images/canister/pc-1466-fr.png' },
  ...
  skin: {
    ...
    products: [
      ...
      { name: 'Crème Hydratante FPS 30',    description: "Protection solaire SPF 30 + hydratation intense. Une crème deux-en-un qui protège des UV tout en nourrissant la peau en profondeur au quotidien. Texture légère non grasse qui pénètre rapidement.", price: '55€', image: 'https://www.vercorssportsteam.com/wp-content/uploads/2019/04/vercorssportsteam-photo-SKIN-Eclat-Quotidien-Herbalife-600x600.jpg' },
      { name: 'Sérum Rides',                description: "Concentré anti-rides haute efficacité. Formule enrichie en actifs régénérants qui ciblent les rides installées et préviennent l'apparition de nouvelles rides. Texture soyeuse à absorption rapide pour un fini lisse et tendu.", price: '75€', image: 'https://www.vercorssportsteam.com/wp-content/uploads/2025/10/vercorssportsteam-hl-skin-serum-10.png' },
      ...
      { name: 'Crème Hydrant Éclat',        description: "Crème hydratante quotidienne qui révèle l'éclat naturel de la peau. Sa formule légère enrichie en actifs illuminateurs unifie le teint et atténue les signes de fatigue. Pénètre rapidement sans laisser de film gras. Idéale comme base de maquillage.", price: '55€', image: 'https://www.herbalife.com/dmassets/market-reusable-assets/emea/france/images/canister/pc-0830-fr.png' },
      { name: 'Crème Hydrant Yeux',         description: "Crème hydratante spécifiquement formulée pour la zone fragile du contour des yeux. Sa texture fluide et pénétrante apporte une hydratation intense et continue tout au long de la journée. Apaise les tiraillements et lisse les ridules de déshydratation.", price: '45€', image: 'https://www.herbalife.com/dmassets/market-reusable-assets/emea/france/images/canister/pc-515k-fr.png' },
      ...
      { name: 'Gommage',                    description: "Exfoliant doux pour peau lumineuse. Élimine les cellules mortes et affine le grain de peau pour un teint éclatant et uniforme. Sa formule aux micro-grains lisse sans agresser.", price: '29€', image: 'https://www.herbalife.com/dmassets/market-reusable-assets/emea/france/images/canister/pc-528k-fr.png' },
      ...
      { name: 'Exfoliant',                  description: "Gommage corps à grains fins pour une peau douce et lumineuse. Sa formule enrichie en agents exfoliants naturels élimine en douceur les cellules mortes et les aspérités. La peau est lissée, revitalisée et parfaitement préparée à recevoir les soins hydratants.", price: '24€', image: 'https://www.herbalife.com/dmassets/market-reusable-assets/emea/france/images/canister/pc-0766-fr.png' },
    ],
  },
};
