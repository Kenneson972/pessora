...
export const rangesData = {
  ...
  skin: {
    ...
    products: [
      ...
      { name: 'Crème Hydratante FPS 30',    description: "Protection solaire SPF 30 + hydratation intense. Une crème deux-en-un qui protège des UV tout en nourrissant la peau en profondeur au quotidien. Texture légère non grasse qui pénètre rapidement.", price: '55€', image: 'https://www.herbalife.com/dmassets/market-reusable-assets/emea/france/images/canister/pc-0828-fr.png' },
      { name: 'Sérum Rides',                description: "Concentré anti-rides haute efficacité. Formule enrichie en actifs régénérants qui ciblent les rides installées et préviennent l'apparition de nouvelles rides. Texture soyeuse à absorption rapide pour un fini lisse et tendu.", price: '75€', image: 'https://www.herbalife.com/dmassets/market-reusable-assets/emea/france/images/canister/pc-0829-fr.png' },
      ...
      { name: 'Crème Hydrant Yeux',         description: "Crème hydratante spécifiquement formulée pour la zone fragile du contour des yeux. Sa texture fluide et pénétrante apporte une hydratation intense et continue tout au long de la journée. Apaise les tiraillements et lisse les ridules de déshydratation.", price: '45€', image: 'https://www.herbalife.com/dmassets/market-reusable-assets/emea/france/images/canister/pc-0771-fr.png' },
