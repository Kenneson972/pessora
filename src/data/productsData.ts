...
export const rangesData = {
  wellness: {
    ...
    products: [
      ...
      { name: 'Collagène',        description: "Complément au collagène hydrolysé, vitamine C et biotine. Contribue à l'élasticité et la fermeté de la peau tout en soutenant la santé des ongles et des articulations.", price: '85€' },
  ...
  sport: {
    ...
    products: [
      ...
      { name: 'Omega 3',                 description: "Complément en acides gras oméga-3 d'origine marine. Contribue à la santé cardiovasculaire, au bon fonctionnement cérébral et à la réduction des inflammations.", price: '40€' },
      { name: 'Hydrate',                 description: "Boisson d'hydratation formulée pour remplacer les électrolytes perdus pendant l'exercice. Aide à prévenir les crampes et maintenir les performances.", price: '50€' },
  ...
  skin: {
    ...
    products: [
      ...
      { name: 'Lotion Tonique Revitalisant',description: "Tonifie et revitalise le teint. Prépare la peau à recevoir les soins suivants tout en resserrant les pores pour un fini lisse et frais.", price: '22€' },
