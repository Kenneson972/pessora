      ...
      <div className="section-wrapper">
        ...
        <div className="relative">
          ...
          <Button
            ...
            variant="ghost"
            onClick={scrollNext}
            className="absolute right-0 top-[min(40%,120px)] z-10 hidden h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full border border-noir/[0.12] bg-white text-black/70 shadow-[0_4px_24px_rgba(0,0,0,0.06)] transition-colors hover:border-sapin/30 hover:text-sapin md:flex"
