            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <Button
                  ...
                  className="self-start h-11 min-h-11 rounded-full border border-white/30 bg-noir/[0.8] backdrop-blur-sm px-5 text-[12px] uppercase tracking-[0.14em] text-white hover:bg-noir/[0.7]"
                >
                  Voir la gamme
                </Button>
              </motion.div>
