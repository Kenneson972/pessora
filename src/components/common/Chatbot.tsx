            ...
            >
              ...
              <div className="relative flex min-h-0 flex-1 flex-col">
                ...
                <Button
                  ...
                  className={cn(
                    focusLink,
                    'absolute right-2 top-2 z-20 flex h-11 w-11 items-center justify-center rounded-[2px] border border-white/30 bg-noir/40 text-white backdrop-blur-md transition-colors hover:bg-noir/55 sm:right-3 sm:top-3'
                  )}
                >
