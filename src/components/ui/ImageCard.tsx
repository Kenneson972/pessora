    ...
    <Card
      ...
      className={cn(
        ...
        isDark
          ...
          : 'motion-safe:group-hover:ring-1 motion-safe:group-hover:ring-inset motion-safe:group-hover:ring-sapin/10',
        aspectRatio,
        isDark
          ? 'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:ring-inset'
          : 'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sapin/20 focus-visible:ring-inset',
      )}
      onClick={onPress}
