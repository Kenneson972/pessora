...
/**
 * Convertit une photo HEIC en JPEG AVANT l'envoi.
 *
 * Pourquoi c'est ici et pas côté serveur : le bucket accepte le HEIC depuis le
 * 17/09, mais un HEIC ne s'affiche **que dans Safari** — sur Chrome et Android les
 * photos déposées casseraient. Catherine déposera depuis son téléphone, donc la
 * conversion se fait au moment du dépôt, pendant que le navigateur sait encore lire
 * le fichier (Safari décode le HEIC ; Chrome, non — d'où le message d'aide).
 */
async function toJpegSiHeic(file: File): Promise<File> {
