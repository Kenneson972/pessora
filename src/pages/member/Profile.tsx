      ...
      <div className="lg:col-span-8 flex flex-col gap-4">
            ...
            {[
              ...
              <div key={field.label} className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className="w-full h-11 bg-noir/[0.03] rounded-[2px] px-4 text-base font-normal text-black border border-transparent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sapin/25 transition-colors duration-200"
                />
              </div>
            ))}
            <div className="flex flex-col gap-2">
        ...
        <div className="bg-white rounded-[2px] p-8 border border-noir/[0.06]">
          ...
          <form onSubmit={handlePasswordSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            {passwordSuccess && (
              <p className="md:col-span-2 text-[11px] text-sapin font-medium" role="status">
