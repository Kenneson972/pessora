...
import { ChevronLeft, ChevronRight, CheckCircle, AlertCircle, Clock, CalendarDays, ArrowRight } from 'lucide-react';
          ...
          return (
            ...
            >
              ...
              {isAvailable && !isPast && !isSelected && (
                <span className="w-1 h-1 rounded-full bg-sapin/60 mt-0.5 block" />
              )}
            </button>
          );
        })}
  ...
  return (
    ...
    <div>
      ...
      <div className={DASH_MAIN_PAD}>
        ...
        {submitStatus === 'success' ? (
          <DashCard className="text-center py-12" aria-live="polite">
            <CheckCircle size={44} strokeWidth={1} className="text-sapin mx-auto mb-5" aria-hidden="true" />
      ...
      <ConfirmDialog
        ...
        description="Tu pourras en réserver un nouveau à tout moment."
