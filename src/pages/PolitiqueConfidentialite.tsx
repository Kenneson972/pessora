    ...
    <div className="min-h-screen bg-white pb-20 pt-8 md:pt-12">
      <PageShell>
        <div className="mx-auto max-w-3xl">
          <p className="mb-2 text-[10px] font-normal uppercase tracking-[0.24em] text-black/40">Données personnelles</p>
          <h1
          ...
          <p className="mb-12 text-[13px] font-normal leading-relaxed text-black/50">
          ...
          <section className="mb-10">
            ...
            <p className="text-[13px] font-normal leading-relaxed text-black/60">
          ...
          <section className="mb-10">
            ...
            <ul className="list-inside list-disc space-y-2 text-[13px] font-normal leading-relaxed text-black/60">
              <li>
