          ...
          <div className="h-fit w-full min-w-0 lg:sticky lg:top-36">
            ...
            <div className="mb-6 flex flex-col items-stretch gap-4 sm:flex-row sm:items-center">
              ...
              <Button
                ...
                className="flex h-12 min-h-12 flex-1 items-center justify-center gap-3 rounded-full bg-sapin text-[10px] font-normal uppercase tracking-[0.12em] text-white hover:bg-sapin/80"
              >
                {justAdded ? (
